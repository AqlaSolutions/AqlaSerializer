...
namespace AqlaSerializer.unittest.Meta
{
    ...
    public class PocoListTests
    {
        ...
        public void AddOnTypedListShouldResolveCorrectly_String()
        {
            ...
            Assert.AreEqual(typeof(string), model[typeof(TypeWithLists)][1].GetFinalSettingsCopy().Collection.ItemType, "ItemType");
            Assert.AreEqual(typeof(List<string>), model[typeof(TypeWithLists)][1].MemberType, "MemberType");
            Assert.AreEqual(typeof(List<string>), model[typeof(TypeWithLists)][1].GetFinalSettingsCopy().Collection.ConcreteType, "DefaultType");
        }
        ...
        public void AddOnTypedListShouldResolveCorrectly_Int32()
        {
            ...
            Assert.AreEqual(typeof(TypeWithLists), model[typeof(TypeWithLists)][1].ParentType, "ParentType");
            Assert.AreEqual(typeof(int), model[typeof(TypeWithLists)][1].GetFinalSettingsCopy().Collection.ItemType, "ItemType");
            Assert.AreEqual(typeof(List<int>), model[typeof(TypeWithLists)][1].MemberType, "MemberType");
            Assert.AreEqual(typeof(List<int>), model[typeof(TypeWithLists)][1].GetFinalSettingsCopy().Collection.ConcreteType, "DefaultType");
        }
        ...
        public void AddOnTypedIListShouldResolveCorrectly_String()
        {
            ...
            Assert.AreEqual(typeof(string), model[typeof(TypeWithLists)][2].GetFinalSettingsCopy().Collection.ItemType, "ItemType");
            Assert.AreEqual(typeof(IList<string>), model[typeof(TypeWithLists)][2].MemberType, "MemberType");
            Assert.AreEqual(typeof(List<string>), model[typeof(TypeWithLists)][2].GetFinalSettingsCopy().Collection.ConcreteType, "DefaultType");
        }
        ...
        public void AddOnTypedIListShouldResolveCorrectly_Int32()
        {
            ...
            Assert.AreEqual(typeof(TypeWithLists), model[typeof(TypeWithLists)][2].ParentType, "ParentType");
            Assert.AreEqual(typeof(int), model[typeof(TypeWithLists)][2].GetFinalSettingsCopy().Collection.ItemType, "ItemType");
            Assert.AreEqual(typeof(IList<int>), model[typeof(TypeWithLists)][2].MemberType, "MemberType");
            Assert.AreEqual(typeof(List<int>), model[typeof(TypeWithLists)][2].GetFinalSettingsCopy().Collection.ConcreteType, "DefaultType");
        }
