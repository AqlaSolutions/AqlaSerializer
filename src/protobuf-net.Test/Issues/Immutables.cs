...
#pragma warning restore CS0618
            ...
            Assert.AreEqual((IEnumerable<string>)testClass.Array, (IEnumerable<string>)testClassClone.Array);
        }
...
#pragma warning restore CS0618
            ...
            Assert.AreEqual((IEnumerable<string>)testClass.List, (IEnumerable<string>)testClassClone.List);
        }
...
#pragma warning restore CS0618
            ...
            Assert.AreEqual((IEnumerable<string>)testClass.Set, (IEnumerable<string>)testClassClone.Set);
        }
...
#pragma warning restore CS0618
            ...
            Assert.AreEqual((IEnumerable<KeyValuePair<string, string>>)testClass.Dictionary.OrderBy(x => x.Key), (IEnumerable<KeyValuePair<string, string>>)testClassClone.Dictionary.OrderBy(x => x.Key));
        }
...
#pragma warning restore CS0618
            ...
            Assert.AreEqual((IEnumerable<KeyValuePair<string, string>>)testClass.Dictionary, (IEnumerable<KeyValuePair<string, string>>)testClassClone.Dictionary);
        }
