...
namespace ProtoBuf.Test.Issues
{
    public class Issue598
    {
        ...
        public void RoundTripCustomSerializerScalar()
        {
            ...
            Assert.AreEqual("08-B9-60-12-03-61-62-63", hex);
            ms.Position = 0;
            var clone = Serializer.Deserialize<Item>(ms);
            Assert.AreEqual(12345, (long)clone.CustomId);
            Assert.AreEqual("abc", clone.Description);
        }
        ...
        {
            Assert.AreEqual(CustomHtmlString.Empty, RoundTrip<CustomHtmlString, CustomHtmlString>(CustomHtmlString.Empty));
            Assert.AreEqual(string.Empty, RoundTrip<CustomHtmlString, string>(CustomHtmlString.Empty));
            Assert.AreEqual(CustomHtmlString.Empty, RoundTrip<string, CustomHtmlString>(string.Empty));
        }
        ...
        public void ProtoBuf_Null_Propagation()
        {
            ...
            Assert.AreEqual(expectation, RoundTrip<CustomHtmlString, CustomHtmlString>(null)?.ToHtmlString());
            Assert.AreEqual(expectation, RoundTrip<string, CustomHtmlString>(null)?.ToHtmlString());
            Assert.AreEqual(expectation, RoundTrip<CustomHtmlString, string>(null));
        }
        ...
        public void ProtoBuf_Nested_Html_To_Html()
        {
            ...
            Assert.AreEqual(original, cloned.HtmlString);
        }
        ...
        public void ProtoBuf_Nested_String_To_Html()
        {
            ...
            Assert.Null(cloned.HtmlList);
            Assert.AreEqual(original, cloned.HtmlString.ToHtmlString());
        }
        ...
        public void ProtoBuf_Nested_Html_To_String()
        {
            ...
            Assert.Null(cloned.HtmlList);
            Assert.AreEqual(original.ToHtmlString(), cloned.HtmlString);
        }
        ...
        public void ProtoBuf_NestedList_Html_To_Html()
        {
            ...
            Assert.AreEqual(original, cloned.HtmlList.Single());
        }
        ...
        public void ProtoBuf_NestedList_String_To_Html()
        {
            ...
            Assert.Null(cloned.HtmlString);
            Assert.AreEqual(original, cloned.HtmlList.Single().ToHtmlString());
        }
        ...
        public void ProtoBuf_NestedList_Html_To_String()
        {
            ...
            Assert.Null(cloned.HtmlString);
            Assert.AreEqual(original.ToHtmlString(), cloned.HtmlList.Single());
        }
        ...
        public readonly struct CustomType : IEquatable<CustomType>
        {
            public class Serializer : ISerializer<CustomType>
            {
                ...
                public CustomType Read(ref ProtoReader state, CustomType value)
                    => state.ReadInt64();

                public void Write(ref ProtoWriter state, CustomType value)
        ...
        public class CustomHtmlString
        {
            ...
            public class ProtoBufSerializer : ISerializer<CustomHtmlString>, IFactory<CustomHtmlString>
            {
                ...
                CustomHtmlString ISerializer<CustomHtmlString>.Read(ref ProtoReader state, CustomHtmlString value)
                    => state.ReadString() is string str ? Create(str) : null;

                void ISerializer<CustomHtmlString>.Write(ref ProtoWriter state, CustomHtmlString value)
                {
