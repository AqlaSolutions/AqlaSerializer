...
namespace ProtoBuf.Test.Issues
{
    public class SO60842788
    {
        ...
        public void CanRoundTripWrapped()
        {
            ...
            Assert.AreEqual(2, clone.Vector.Length);
            Assert.AreEqual(typeof(string), clone.Vector[0]);
            Assert.AreEqual(typeof(uint), clone.Vector[1]);
        }
        ...
        public void CanRoundTripVector()
        {
            ...
            Assert.AreEqual(typeof(string), clone[0]);
            Assert.AreEqual(typeof(uint), clone[1]);
        }
