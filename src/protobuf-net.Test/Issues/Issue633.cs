...
namespace ProtoBuf.Test.Issues
{
    ...
    {
        [Test]
        [TestCase(typeof(HasReservedDistinctField), "Field 31 is reserved and cannot be used for data member 'B' (iz 31).")]
        [TestCase(typeof(HasReservedDistinctFieldEnum), "Field 31 is reserved and cannot be used for enum value 'B' (iz 31).")]
        [TestCase(typeof(HasReservedDistinctFieldSubType), "Field 31 is reserved and cannot be used for sub-type 'ProtoBuf.Test.Issues.Issue633+HasReservedDistinctFieldSubType+B' (iz 31).")]
        [TestCase(typeof(HasReservedRangeField), "Field 32 is reserved and cannot be used for data member 'B' (iz 32).")]
        [TestCase(typeof(HasReservedRangeFieldEnum), "Field 32 is reserved and cannot be used for enum value 'B' (iz 32).")]
        [TestCase(typeof(HasReservedRangeFieldSubType), "Field 32 is reserved and cannot be used for sub-type 'ProtoBuf.Test.Issues.Issue633+HasReservedRangeFieldSubType+B' (iz 32).")]
        [TestCase(typeof(HasReservedNameField), "Field 'B' is reserved and cannot be used for data member 33 (iz B).")]
        [TestCase(typeof(HasReservedNameFieldEnum), "Field 'B' is reserved and cannot be used for enum value 33 (iz B).")]
        [TestCase(typeof(HasReservedNameFieldSubType), "Field 'B' is reserved and cannot be used for sub-type 33 (iz B).")]
