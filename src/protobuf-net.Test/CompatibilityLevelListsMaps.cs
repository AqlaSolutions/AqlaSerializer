...
namespace ProtoBuf.Test
{
    public class CompatibilityLevelListsMaps
    {
        ...
        public CompatibilityLevelListsMaps() { }
...
", Serializer.GetProto<HazLists>(ProtoSyntax.Proto3));
...
", Log(Serializer.GetProto<HazMaps>(ProtoSyntax.Proto3)));
        ...
        public void AssertExpectedDateTimeValues()
        {
            ...
            Assert.AreEqual(18413, delta.TotalDays);
            Assert.AreEqual(1590883200, delta.TotalSeconds);
        }
...
", Serializer.GetProto<HazGuids>(ProtoSyntax.Proto3));
...
", Serializer.GetProto<HazGuids300>(ProtoSyntax.Proto3));
...
", Serializer.GetProto<HazGuids300Fixed>(ProtoSyntax.Proto3));
...
", Serializer.GetProto<HazDecimals>(ProtoSyntax.Proto3));
...
", Serializer.GetProto<HazDecimals300>(ProtoSyntax.Proto3));
...
", Log(Serializer.GetProto<HazSingleSigned>(ProtoSyntax.Proto3)));
...
", Log(Serializer.GetProto<HazMultipleSigned>(ProtoSyntax.Proto3)));
