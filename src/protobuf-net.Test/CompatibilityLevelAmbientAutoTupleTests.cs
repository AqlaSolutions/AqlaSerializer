...
namespace ProtoBuf.Test
{
    ...
    {
        public CompatibilityLevelAmbientAutoTupleTests()
            { }
...
message ValueTuple_Guid_Decimal {
   ...
   string Item2 = 2;
        ...
        public void Level300Payload_CheckActual()
        {
            ...
            ms.SetLength(0);
            Log(hex);
            Assert.AreEqual("0A-0D-0A-06-08-D7-E7-EA-F6-05-12-03-08-BC-20-12-2E-0A-24-35-61-30-39-36-30-65-62-2D-"
...
message ValueTuple_Timestamp_String {
   ...
   string Item2 = 2;
        ...
        private void AssertSchema<T>(string expected)
        {
            ...
            Log(schema);
            Assert.AreEqual(expected.Trim(), schema.Trim());
        }
        ...
        public void DetectInvalidModel()
        {
            ...
            Assert.AreEqual("The tuple-like type System.ValueTuple`2[System.DateTime,System.TimeSpan] must use a single compatiblity level, but 'Level200' and 'Level300' are both observed; this usually means it is being used in different contexts in the same model.", ex.Message);
        }
