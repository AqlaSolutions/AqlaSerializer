...
namespace ProtoBuf.Meta
{
    public class ProviderTests
    {
        ...
        public void SerializerConfigBasicSetup()
        {
            ...
            Assert.AreEqual(typeof(EnumSerializerInt32<A>), serType);
            Assert.AreEqual(typeof(A), serType.GetGenericArguments().Single());
        ...
        class MyProvider : ISerializer<Haz>, ISerializerProxy<A>, ISerializerProxy<A?>, ISerializerProxy<Proxied>
        {
            ...
            Haz ISerializer<Haz>.Read(ref ProtoReader state, Haz value)
                => throw new NotImplementedException();

            void ISerializer<Haz>.Write(ref ProtoWriter state, Haz value)
                => throw new NotImplementedException();
        }
        ...
        class ProxySerializer : ISerializer<Proxied>
        {
            ...
            Proxied ISerializer<Proxied>.Read(ref ProtoReader state, Proxied value)
                => throw new NotImplementedException();

            void ISerializer<Proxied>.Write(ref ProtoWriter state, Proxied value)
                => throw new NotImplementedException();
        }
        class Haz { }
        class HazNot { }
