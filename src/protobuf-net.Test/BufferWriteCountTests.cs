    ...
    public class BufferWriteCountTests
    {
        ...
        class MyTypeModel : TypeModel
        {
            ...
            class MyServices : ISerializer<MyMessage>
            {
                ...
                public MyMessage Read(ref ProtoReader state, MyMessage value)
                {
                    value ??= new MyMessage();
                    int field;
                ...
                public void Write(ref ProtoWriter state, MyMessage value)
                {
        ...
        public void WriteAllTheThings()
        {
            ...
            var state = new ProtoWriter(cw, MyTypeModel.Instance);
            try
            {
                ...
                Assert.AreEqual(cw.TotalBytes, state.GetPosition());
                ...
                for (int i = 0; i < ITER_COUNT; i++)
                {
                    repeatedInt32.WriteRepeated(state, GetField(), SerializerFeatures.WireTypeVarint, GetValuesInt32());
                }
                state.Flush();
                ...
                for (int i = 0; i < ITER_COUNT; i++)
                {
                    repeatedInt32.WriteRepeated(state, GetField(), SerializerFeatures.WireTypeSignedVarint, GetValuesInt32());
                }
                state.Flush();
                ...
                for (int i = 0; i < ITER_COUNT; i++)
                {
                    repeatedInt32.WriteRepeated(state, GetField(), SerializerFeatures.WireTypeFixed32, GetValuesInt32());
                }
                state.Flush();
                ...
                for (int i = 0; i < ITER_COUNT; i++)
                {
                    repeatedInt32.WriteRepeated(state, GetField(), SerializerFeatures.WireTypeFixed64, GetValuesInt32());
                }
                state.Flush();
                ...
                for (int i = 0; i < ITER_COUNT; i++)
                {
                    repeatedInt32.WriteRepeated(state, GetField(), SerializerFeatures.WireTypeVarint | SerializerFeatures.OptionPackedDisabled, GetValuesInt32());
                }
                state.Flush();
                ...
                for (int i = 0; i < ITER_COUNT; i++)
                {
                    repeatedInt32.WriteRepeated(state, GetField(), SerializerFeatures.WireTypeSignedVarint | SerializerFeatures.OptionPackedDisabled, GetValuesInt32());
                }
                state.Flush();
                ...
                for (int i = 0; i < ITER_COUNT; i++)
                {
                    repeatedInt32.WriteRepeated(state, GetField(), SerializerFeatures.WireTypeFixed32 | SerializerFeatures.OptionPackedDisabled, GetValuesInt32());
                }
                state.Flush();
                ...
                for (int i = 0; i < ITER_COUNT; i++)
                {
                    repeatedInt32.WriteRepeated(state, GetField(), SerializerFeatures.WireTypeFixed64 | SerializerFeatures.OptionPackedDisabled, GetValuesInt32());
                }
                state.Flush();
                ...
                {
                    repeatedString.WriteRepeated(state, GetField(), SerializerFeatures.WireTypeString, GetValuesString());
                }
                state.Flush();
                ...
                for (int i = 0; i < SMALL_ITER_COUNT; i++)
                {
                    repeatedMessage.WriteRepeated(state, GetField(), SerializerFeatures.WireTypeString, GetValuesMessage());
                }
                state.Flush();
                ...
                for (int i = 0; i < SMALL_ITER_COUNT; i++)
                {
                    repeatedMessage.WriteRepeated(state, GetField(), SerializerFeatures.WireTypeStartGroup, GetValuesMessage());
                }
                state.Flush();
