...
namespace ProtoBuf
{
    public class CustomSerializers
    {
        ...
        public void CustomSerializerDetectedOnModel()
        {
            ...
            Assert.AreEqual(typeof(CustomSerializer), rt.SerializerType);
        ...
        public void CustomSerializerWorks()
        {
            ...
            Assert.AreEqual(CustomSerializerOperations.None, obj.ViaCustomSerializer);

            var clone = Serializer.DeepClone(obj);
            Assert.AreNotSame(obj, clone);
            Assert.AreEqual(CustomSerializerOperations.Write, obj.ViaCustomSerializer);
            Assert.AreEqual(CustomSerializerOperations.Read, clone.ViaCustomSerializer);
            Assert.AreEqual(nameof(CustomSerializerWorks), clone.Inner.Name);
        }
        ...
        public class CustomSerializer : ISerializer<HazCustomSerializer>, ISerializerProxy<HazIndirectCustomSerializer>
        {
            ...
            void ISerializer<HazCustomSerializer>.Write(ref ProtoWriter state, HazCustomSerializer value)
            {
                state.WriteMessage(1, default, value.Inner);
                value.ViaCustomSerializer |= CustomSerializerOperations.Write;
            }

            HazCustomSerializer ISerializer<HazCustomSerializer>.Read(ref ProtoReader state, HazCustomSerializer value)
            {
                int field;
        ...
        public class IndirectSerializer : ISerializer<HazIndirectCustomSerializer>
        {
            ...
            HazIndirectCustomSerializer ISerializer<HazIndirectCustomSerializer>.Read(ref ProtoReader state, HazIndirectCustomSerializer value)
            {
                int field;
            ...
            void ISerializer<HazIndirectCustomSerializer>.Write(ref ProtoWriter state, HazIndirectCustomSerializer value)
            {
