...
namespace ProtoBuf.Issues
{
    public class Issue713
    {
        ...
        public void CanNotSerializeNullableInt32Array_WithNulls()
        {
            ...
            Assert.AreEqual("An element of type System.Nullable`1[System.Int32] was null; this might be as contents in a list/array", ex.Message);
        }
        ...
        public void CanNotSerializeNullableSomeEnumArray_WithNulls()
        {
            ...
            using var ms = new MemoryStream();
            var ex = Assert.Throws<NullReferenceException>(() => Serializer.Serialize(ms, orig));
            Assert.AreEqual("An element of type System.Nullable`1[ProtoBuf.Issues.Issue713+SomeEnum] was null; this might be as contents in a list/array", ex.Message);
        }
