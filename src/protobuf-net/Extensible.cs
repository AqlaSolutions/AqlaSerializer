...
namespace AqlaSerializer
{
    ...
    public abstract class Extensible : IExtensible
    {
        ...
        /// <param name="tag">The field identifier; the tag should not be defined as a known data-field for the instance.</param>
        /// <param name="value">The value to append.</param>
        public static void AppendValue<TValue>(TypeModel model, IExtensible instance, int tag, BinaryDataFormat format, TValue value)
        {
        ...
        {
            return GetValue<TValue>(RuntimeTypeModel.Default, instance, tag);
        }
        ...
        /// <param name="tag">The field identifier; the tag should not be defined as a known data-field for the instance.</param>
        /// <returns>The effective value of the field, or the default value if not found.</returns>
        public static TValue GetValue<TValue>(TypeModel model, IExtensible instance, int tag)
        {
            return GetValue<TValue>(model, instance, tag, BinaryDataFormat.Default);
        }
        ...
        {
            return GetValue<TValue>(RuntimeTypeModel.Default, instance, tag, format);
        }
        ...
        {
            return GetValues<TValue>(RuntimeTypeModel.Default, instance, tag);
        }
        ...
        /// <param name="tag">The field identifier; the tag should not be defined as a known data-field for the instance.</param>
        /// <returns>An enumerator that yields each occurrence of the field.</returns>
        public static IEnumerable<TValue> GetValues<TValue> (TypeModel model, IExtensible instance, int tag)
        {
            return model.ExtensibleUtil.GetExtendedValues<TValue>(instance, tag, BinaryDataFormat.Default, false, false);
        }
