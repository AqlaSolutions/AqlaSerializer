...
AqlaSerializer project goal is not to make a Protocol Buffers implementation but instead support all common .NET features. There will be still a "compatible mode" to support Protocol Buffers.
