...
AqlaSerializer is an *object* serializer, it's goal is not to make just a Protocol Buffers implementation but also support all important .NET features like nested collections, references, etc. There will be still a "compatible mode" to support Protocol Buffers.
